# Contributing to Iris assistant widget
...
Feature branches are `feature/IRIS-1234-short-description`. Also permitted: `bugfix/`, `hotfix/`,
`spike/`, `chore/`. The pre-commit hook rejects anything else.

## Commits

`IRIS-1234 imperative summary`, 72 characters or fewer, with an optional body explaining why. The
